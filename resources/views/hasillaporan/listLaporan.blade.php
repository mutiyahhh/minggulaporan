                    ...
                    <tbody>
                        @foreach($judulLaporan as $index => $judul)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('lihathasilTahun', ['id' => $judul->id, 'is_monthly' => app('request')->input('is_monthly') ]) }}" class="btn btn-primary">
                                        Lihat Tahun
                                    </a>
                                </td>
                            </tr>
                    ...
                    <tbody>
                        @foreach($judulLaporan as $index => $judul)
                            <tr>
                                ...
                                <td>{{ $judul->judul_laporan }}</td>
                                <td>
                                    <a href="{{ route('hasiltahunLaporan', ['id' => $judul->id, 'is_monthly' => app('request')->input('is_monthly') ]) }}" class="btn btn-primary">
                                        Lihat Tahun
                                    </a>
                                </td>
                            </tr>

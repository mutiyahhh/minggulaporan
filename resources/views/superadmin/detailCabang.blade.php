...
@section('content')
<div class="container">
    <h3>Detail Cabang: {{ $cabang->nama_cabang }}</h3>
    <p>Area cabang: {{ $cabang->area }}</p>
    <p>Alamat: {{ $cabang->alamat }}</p>
    <p>Nomor HP: {{ $cabang->nomor_hp }}</p>

    <h2>Daftar Karyawan</h2>
    <a href="{{ route('tambahUsers', ['cabang_id' => $cabang->id]) }}" class="btn btn-secondary">Tambah Pengelola Cabang</a>

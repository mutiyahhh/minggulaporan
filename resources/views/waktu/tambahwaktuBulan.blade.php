...
<div class="container-fluid">
    <div class="container rounded bg-white mt-4 mb-4">
        <div class="row">
            <div class="container">
                <h1>Tambah Waktu Laporan Bulanan untuk Tahun {{ \Carbon\Carbon::parse($waktu_tahun->waktu_tahun_laporan)->format('Y') }}</h1>
                <form action="{{ route('storeBulan', $waktu_tahun->id) }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        <label for="waktu_bulan_laporan" class="form-label">Waktu Bulan Laporan</label>
                        <input type="month" class="form-control" id="waktu_bulan_laporan" name="waktu_bulan_laporan" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-primary">Tambah Waktu Bulan</button>
